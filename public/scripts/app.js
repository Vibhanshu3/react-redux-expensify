...
var IndecisionApp = function (_React$Component) {
    ...
    _createClass(IndecisionApp, [{
        ...
        value: function componentDidMount() {
            ...
            var options = JSON.toUpperCase(json);
        ...
        value: function render() {
            var subtitile = 'Put your life in the hands of a computer';

            return React.createElement(
                'div',
                null,
                React.createElement(Header, { subtitile: subtitile }),
...
var Header = function Header(props) {
    return React.createElement(
        ...
        props.subtitile && React.createElement(
            'h2',
            null,
            props.subtitile
        )
